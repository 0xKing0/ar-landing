      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button className="text-sm uppercase tracking-wider text-gray-300 hover:text-white transition-colors">
              Login
            </button>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-white/10">
            <div className="flex flex-col gap-4">
              ...
              <button className="text-sm uppercase tracking-wider text-gray-300 hover:text-white transition-colors text-left">
                Login
              </button>
              <button className="px-6 py-2.5 bg-military-green hover:bg-military-green-light text-black transition-colors uppercase tracking-wider text-sm">
                Get Started
